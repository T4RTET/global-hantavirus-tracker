...
export const demoReports: Report[] = [
  ...
  },
  {
    ...
    source_type: "news",
    confidence: "medium",
    summary: "Netherlands-linked reporting is used here as the main cluster report so the tracker total reaches 8 confirmed cases. Travel-linked; not proof of local spread.",
