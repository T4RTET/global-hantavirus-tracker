...
export const demoReports: Report[] = [
  ...
  },
  {
    ...
    source_name: "UN Geneva / WHO",
    source_url: "https://www.ungeneva.org/en/news-media/news/2026/05/118402/hantavirus-outbreak-cruise-ship-not-another-covid-who-says",
    source_type: "official",
    confidence: "high",
    summary: "WHO said eight cases had been reported so far in the cruise-ship cluster: five laboratory-confirmed infections, three suspected cases, and three deaths. WHO assessed the global public health risk as low.",
    raw_title: "Hantavirus outbreak on cruise ship not another COVID, WHO says",
    raw_text: null,
    created_at: now,
    updated_at: now
  },
